...
| 10 | Call hierarchy                  | 71   | `call_hierarchy.{ml,mli}` | `protocol.ml`, `server.ml`                       | Done        |
...
| 15 | Pull-based diagnostics          | 71   | —                         | `server.ml`, `protocol.ml`                       | Done        |
| 16 | Dynamic registration            | 71   | —                         | `server.ml`, `protocol.ml`                       | Done        |
