...
(** [infer_defun env sexp] infers the type of a defun and returns the binding info.

    Returns [Some] with the function name and type if [sexp] is a defun form,
    or [None] otherwise. The returned type is already generalized. *)
